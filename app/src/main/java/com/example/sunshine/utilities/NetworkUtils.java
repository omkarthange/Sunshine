...
public final class NetworkUtils {
    ...
    private static final String PuneOneDay = "https://api.openweathermap.org/data/2.5/weather?q=Pune&appid=7620066da2e9f88af3388aa913778ee0";

    private static final String PuneFiveDays = "https://api.openweathermap.org/data/2.5/forecast?";

    private static final String FORECAST_BASE_URL = PuneFiveDays;
    ...
    private static final String APP_ID = "7620066da2e9f88af3388aa913778ee0";
...
//        return buildUrlWithLocationQuery(locationQuery);
    ...
    private static URL buildUrlWithLatitudeLongitude(Double latitude, Double longitude) {
        Uri weatherQueryUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                ...
                .appendQueryParameter(APP_ID_LABEL, APP_ID)
